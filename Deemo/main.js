...
var $author$project$MusicCreator$noteToString = function (notes) {
	switch (notes.$) {
		case 'Empty':
			return 'empty';
		case 'WholeN':
...
var $author$project$MusicCreator$generateName = function (record) {
	...
	return _Utils_ap(
		$author$project$MusicCreator$noteToString(record.note),
		tostring(record.pos));
};
...
var $author$project$MusicCreator$noteFirstPos = -140;
var $author$project$MusicCreator$updateScoreNoteXDict = F2(
	function (dist, list) {
		var xList = A2($author$project$MusicCreator$makeScoreNoteX, $author$project$MusicCreator$noteFirstPos, list);
		var updatePos = F2(
			function (snd, newX) {
...
var $author$project$MusicCreator$updateScoreNoteYDict = function (list) {
	var adjectY = function (p) {
		return (p > 50) ? 50 : ((_Utils_cmp(p, -36) < 0) ? (-36) : p);
	};
	var upadateY = F2(
		function (p, note) {
			return $author$project$MusicCreatorDef$ifRest(note) ? _Utils_Tuple2(p.a, 0) : _Utils_Tuple2(
				p.a,
				adjectY(
...
var $author$project$MusicCreator$scoreNote = function (dist) {
	return A2(
		$elm$core$List$map,
		function (_v0) {
			var a = _v0.a;
...
var $author$project$MusicCreatorDef$defaultFunction = {accidental: $author$project$MusicCreatorDef$defselectAccidentalRec, articulation: $author$project$MusicCreatorDef$NoArticulation, dynamic: $author$project$MusicCreatorDef$defselectDynamicRec, lyric: $author$project$MusicCreatorDef$defaultLyricRec};
...
var $author$project$MusicCreator$adjectmoveSpeed = 2.2;
	...
	function (x, y, list) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				function (x1) {
					return _Utils_Tuple2(x1, 0);
				},
				A2($author$project$MusicCreator$makeScoreNoteX, $author$project$MusicCreator$noteFirstPos, list)));
	});
...
var $author$project$MusicCreator$insertCondition30 = F3(
	function (list, x, y) {
		var head = function () {
		...
		var end = function () {
			var filter = A2(
				...
				A2($author$project$MusicCreator$makeScoreNoteX, $author$project$MusicCreator$noteFirstPos, list));
			var _v0 = $elm$core$List$head(filter);
			if (_v0.$ === 'Just') {
				var a = _v0.a;
				return a;
			} else {
		...
		return (_Utils_cmp(
			x,
			($author$project$MusicCreator$noteFirstPos + $author$project$MusicCreator$noteToSpacing(head)) - 10) > -1) && ((_Utils_cmp(x, end + 30) < 1) && ((_Utils_cmp(y, (-36) - 3) > -1) && (_Utils_cmp(y, 50 + 3) < 1)));
	});
	...
	function (nameOfNote, model) {
		...
		var targetValue = function () {
			var filter1 = A2(
				$elm$core$List$map,
				function (z) {
					return A3($author$project$MusicCreator$insertCondition30, model.scoreNoteList, x, y) ? z : 9999;
				},
				distance);
...
var $author$project$MusicCreator$noteMenuList = _List_fromArray(
...
var $author$project$MusicCreatorDef$noteToFraction = function (notes) {
	switch (notes.$) {
		case 'Empty':
			return 0;
		case 'WholeN':
...
var $author$project$MusicCreator$restMenuList = _List_fromArray(
...
var $author$project$MusicCreator$fractionToNote = F2(
	function (frac, note) {
		var list = $author$project$MusicCreatorDef$ifRest(note) ? $author$project$MusicCreator$restMenuList : $author$project$MusicCreator$noteMenuList;
		var findNote = function (f) {
			return A2(
				...
				function (a) {
					return _Utils_Tuple2(
						a,
						f - $author$project$MusicCreatorDef$noteToFraction(a));
				},
				list);
		};
		...
		var split = function (f) {
			return (!(!f)) ? A2(
				...
				getNote(f).a,
				split(
					f - $author$project$MusicCreatorDef$noteToFraction(
						getNote(f).a))) : _List_Nil;
		};
		return split(frac);
	});
var $author$project$MusicCreator$tsToBase = function (ts) {
	switch (ts.$) {
		case 'Ts44':
			return 4;
		case 'Ts34':
...
var $author$project$MusicCreator$tsToFraction = function (ts) {
	switch (ts.$) {
		case 'Ts44':
			return 4 * (1 / 4);
		case 'Ts34':
...
var $author$project$MusicCreator$onebeat = function (ts) {
	return $author$project$MusicCreator$tsToFraction(ts) / $author$project$MusicCreator$tsToBase(ts);
};
var $elm$core$Basics$truncate = _Basics_truncate;
var $author$project$MusicCreator$autoSplit = F2(
	function (list, ts) {
		var checkEachBeaming = F2(
			function (listx, carry) {
				var xBeatModOneBeat = function (x) {
					return (($author$project$MusicCreatorDef$noteToFraction(x) + carry) / $author$project$MusicCreator$onebeat(ts)) | 0;
				};
				if (!listx.b) {
					return _List_Nil;
				} else {
					...
					var a = _v3.b;
					var xs = listx.b;
					return (!(($author$project$MusicCreatorDef$noteToFraction(a.note) + carry) - ($author$project$MusicCreator$onebeat(ts) * xBeatModOneBeat(a.note)))) ? A2(
						$elm$core$List$cons,
						...
						A2(
							ifFitOneBeat,
							$author$project$MusicCreatorDef$noteToFraction(a.note),
							xs)) : A2(
						$elm$core$List$cons,
						_Utils_Tuple2(name, a),
						A2(
							ifFitOneBeat,
							$author$project$MusicCreatorDef$noteToFraction(a.note) - ($author$project$MusicCreator$onebeat(ts) * xBeatModOneBeat(a.note)),
							xs)));
				}
			});
		var ifFitOneBeat = F2(
			function (count, listx) {
				if (!listx.b) {
					...
					var a = _v1.b;
					var xs = listx.b;
					var nextCount = count + $author$project$MusicCreatorDef$noteToFraction(a.note);
					if (_Utils_eq(
						nextCount,
						$author$project$MusicCreator$onebeat(ts))) {
						return A2(
							$elm$core$List$cons,
							_Utils_Tuple2(name, a),
						...
						if (_Utils_cmp(
							nextCount,
							$author$project$MusicCreator$onebeat(ts)) < 0) {
							return A2(
								$elm$core$List$cons,
								_Utils_Tuple2(name, a),
								A2(ifFitOneBeat, nextCount, xs));
						} else {
							var fillCount = $author$project$MusicCreator$onebeat(ts) - count;
							var split1 = A2($author$project$MusicCreator$fractionToNote, fillCount, a.note);
							var split2 = A2(
								$author$project$MusicCreator$fractionToNote,
								$author$project$MusicCreatorDef$noteToFraction(a.note) - fillCount,
								a.note);
							var adoptNewList = function (listy) {
								return A2(
									$elm$core$List$map,
									function (a2) {
										return _Utils_Tuple2(
...
var $author$project$MusicCreator$checkBeaming = F2(
	function (list, ts) {
		var checkEachBeaming = F3(
			function (currentbeat, listx, carry) {
				...
				if (!listx.b) {
					...
					var x = listx.a;
					var xs = listx.b;
					return (!(($author$project$MusicCreatorDef$noteToFraction(x) + carry) - ($author$project$MusicCreator$onebeat(ts) * xBeatModOneBeat(x)))) ? A3(
						checkEachBeaming,
						...
						ifFitOneBeat,
						currentbeat,
						$author$project$MusicCreatorDef$noteToFraction(x) - ($author$project$MusicCreator$onebeat(ts) * xBeatModOneBeat(x)),
						xs));
				}
			});
		var ifFitOneBeat = F3(
			function (currentbeat, count, listx) {
				if (!listx.b) {
					return (_Utils_cmp(
						count,
						$author$project$MusicCreator$onebeat(ts)) < 1) ? _Utils_Tuple2(0, true) : _Utils_Tuple2(currentbeat + 1, false);
				} else {
					var x = listx.a;
					var xs = listx.b;
					return _Utils_eq(
						count,
						$author$project$MusicCreator$onebeat(ts)) ? A3(
						checkEachBeaming,
						currentbeat + 1,
						A2($elm$core$List$cons, x, xs),
						0) : ((_Utils_cmp(
						count,
						$author$project$MusicCreator$onebeat(ts)) < 0) ? A3(
						ifFitOneBeat,
						currentbeat,
						count + $author$project$MusicCreatorDef$noteToFraction(x),
...
var $author$project$MusicCreatorDef$defselectNoteRec = A5(
	...
	$author$project$MusicCreatorDef$defaultFunction);
var $author$project$MusicCreator$insertCondition25 = F3(
	function (list, x, y) {
		var head = function () {
			var _v1 = $elm$core$List$head(list);
			if (_v1.$ === 'Just') {
		...
		return (_Utils_cmp(
			x,
			($author$project$MusicCreator$noteFirstPos + $author$project$MusicCreator$noteToSpacing(head)) - 10) > -1) && ((_Utils_cmp(x, end + 20) < 1) && ((_Utils_cmp(y, (-36) - 3) > -1) && (_Utils_cmp(y, 50 + 3) < 1)));
	});
...
var $author$project$MusicCreator$changeDrageScoreNoteUpdateScoreNote = F2(
	function (nameOfNote, model) {
		var validateEachBeaming = function (list) {
			return A2(
				$author$project$MusicCreator$checkBeaming,
		...
		var disInitPostList = function () {
			...
			var filter1 = A2(
				$elm$core$List$map,
				function (z) {
					return A3($author$project$MusicCreator$insertCondition25, dumpDrage, initX, initY) ? z : 99999;
				},
				distanceOld);
		...
		var disDragPosList = function () {
			...
			var filter1 = A2(
				$elm$core$List$map,
				function (z) {
					return A3($author$project$MusicCreator$insertCondition25, dumpDrage, x, y) ? z : 199999;
				},
				distanceNew);
		...
		var updateNewList = function () {
			if (validateEachBeaming(newList)) {
				...
				var splitList = A2($author$project$MusicCreator$autoSplit, newList, model.timeSignature);
				return validateEachBeaming(splitList) ? $author$project$MusicCreator$updateScoreName(
					$author$project$MusicCreator$updateScoreNoteYDict(
						A2(
							$author$project$MusicCreator$updateScoreNoteXDict,
							model.sizeofNote,
							$author$project$MusicCreator$clearEmpty(splitList)))) : $author$project$MusicCreator$updateScoreName(
					$author$project$MusicCreator$updateScoreNoteYDict(
						A2(
							$author$project$MusicCreator$updateScoreNoteXDict,
							model.sizeofNote,
...
var $author$project$MusicCreator$ifMeasureUnfull = F2(
	function (list, ts) {
		var tscount = $author$project$MusicCreator$tsToFraction(ts);
		var notecount = A3(
			$elm$core$List$foldl,
			F2(
				function (_v0, b) {
					var name = _v0.a;
					var a = _v0.b;
					return $author$project$MusicCreatorDef$noteToFraction(a.note) + b;
				}),
			0,
			list);
	...
	function (nameOfNote, model) {
		...
		var disList = function () {
			...
			var filter1 = A2(
				$elm$core$List$map,
				function (z) {
					return A3($author$project$MusicCreator$insertCondition30, scoreNoteListAddOne, x, y) ? z : 9999;
				},
				distance);
			var minValue = A3($elm$core$List$foldl, $elm$core$Basics$min, 99999, filter1);
			return A2(
		...
		var updateNewList = function () {
			var validateWholeMeasure = function (list) {
				return A2($author$project$MusicCreator$ifMeasureUnfull, list, model.timeSignature);
			};
			var validateEachBeaming = function (list) {
				return A2(
					$author$project$MusicCreator$checkBeaming,
...
var $author$project$MusicCreator$createaccidentalList = function (list) {
...
var $author$project$MusicCreator$createdynamicList = function (list) {
...
var $author$project$MusicDef$Flat = {$: 'Flat'};
var $author$project$MusicDef$Natural = {$: 'Natural'};
var $author$project$MusicDef$NoAccidental = {$: 'NoAccidental'};
var $author$project$MusicDef$Sharp = {$: 'Sharp'};
var $author$project$MusicCreatorToMusic$toMusicAccidential = function (accidental) {
	var _v0 = accidental.f;
	switch (_v0.$) {
		case 'Sharp':
		...
		case 'Natural':
			return $author$project$MusicDef$Natural;
		default:
...
var $author$project$MusicCreatorDef$scaleNote = 0.45;
var $author$project$MusicCreatorToMusic$toMusicPitch = F2(
	function (_v0, note) {
		var x = _v0.a;
		var y = _v0.b;
		var p = function (cycle) {
			return $elm$core$Basics$round((y - (((-43) * $author$project$MusicCreatorDef$scaleNote) + (24.5 * cycle))) / 3.5);
		};
		...
		return $author$project$MusicCreatorDef$ifRest(note) ? $author$project$MusicDef$Rest : pick(0);
	});
	...
	function (dynamic, note) {
		...
		switch (_v0.$) {
			...
			case 'FF':
				return 1;
			default:
				return $author$project$MusicCreatorDef$ifRest(note) ? (-1) : 0.8;
		}
	});
var $author$project$MusicCreatorToMusic$creatorToMusicNote = function (note) {
	return A6(
		$author$project$MusicDef$Note,
		$author$project$MusicCreatorDef$noteToFraction(note.note),
		A2($author$project$MusicCreatorToMusic$toMusicPitch, note.pos, note.note),
			...
			_List_fromArray(
				[
					...
					[
						...
						A2($elm$core$List$map, $author$project$MusicCreatorToMusic$creatorToMusicNote, noteList))
					])
				]));
	});
...
var $author$project$MusicDef$Woodblock = {$: 'Woodblock'};
var $author$project$MusicCreatorToMusic$metronome = F2(
	function (ts, noteList) {
		return A3(
			$author$project$MusicDef$Music,
			$author$project$MusicDef$Woodblock,
			$author$project$MusicCreatorToMusic$creatorToMusicTimeSigniture(ts),
			_List_fromArray(
				[
					_List_fromArray(
					[
						...
						A2(
							$elm$core$List$map,
							function (a) {
								return A6($author$project$MusicDef$Note, 0.25, $author$project$MusicDef$Ti, 1.0, '', $author$project$MusicDef$BlankScreen, $author$project$MusicDef$NoAccidental);
							},
							noteList))
					])
				]));
	});
var $author$project$PlayBack$metronome = _Platform_outgoingPort('metronome', $elm$core$Basics$identity);
...
var $author$project$PlayBack$encode = function (event) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'pitch',
				$elm$json$Json$Encode$int(event.pitch)),
				_Utils_Tuple2(
				'duration',
...
var $author$project$MusicDef$MusicEvent = F5(
	function (time, pitch, duration, volume, lyric) {
		return {duration: duration, lyric: lyric, pitch: pitch, time: time, volume: volume};
	});
var $author$project$PlayBack$accidentialToNumber = function (accidential) {
	switch (accidential.$) {
		case 'Sharp':
			return 1;
		case 'Flat':
...
var $author$project$PlayBack$getNoteRecord = function (_v0) {
	...
	var lyric = _v0.d;
	var video = _v0.e;
	var accidental = _v0.f;
	return {accidental: accidental, duration: duration, lyric: lyric, pitch: pitch, video: video, volume: volume};
};
...
var $author$project$PlayBack$seqNotesToMEvents = F4(
	function (currentTime, tempo, notes, accidentalDict) {
		...
		if (!notes.b) {
			...
			var newPitch = function () {
				var checkAccidential = A2(
					$elm$core$Dict$get,
					$author$project$PlayBack$pitchToMIDINumber(noteRecord.pitch),
					accidentalDict);
				if (_Utils_eq(noteRecord.accidental, $author$project$MusicDef$NoAccidental)) {
					if (checkAccidential.$ === 'Just') {
						var accidential = checkAccidential.a;
						return $author$project$PlayBack$pitchToMIDINumber(noteRecord.pitch) + $author$project$PlayBack$accidentialToNumber(accidential);
					} else {
						return $author$project$PlayBack$pitchToMIDINumber(noteRecord.pitch);
					}
				} else {
					return $author$project$PlayBack$pitchToMIDINumber(noteRecord.pitch) + $author$project$PlayBack$accidentialToNumber(noteRecord.accidental);
				}
			}();
			var newAccidentalDict = (!_Utils_eq(noteRecord.accidental, $author$project$MusicDef$NoAccidental)) ? A3(
				$elm$core$Dict$insert,
				$author$project$PlayBack$pitchToMIDINumber(noteRecord.pitch),
				noteRecord.accidental,
				accidentalDict) : accidentalDict;
			var clampedVolume = A3($elm$core$Basics$clamp, -1.0, 1.0, noteRecord.volume);
			return A2(
				$elm$core$List$cons,
				A5($author$project$MusicDef$MusicEvent, currentTime, newPitch, noteRecord.duration * metro, clampedVolume, noteRecord.lyric),
				A4($author$project$PlayBack$seqNotesToMEvents, currentTime + (noteRecord.duration * metro), tempo, xs, newAccidentalDict));
		}
	});
			...
			_List_fromArray(
				[
					...
					$elm$json$Json$Encode$int(
						$author$project$PlayBack$instrumentToMIDINumber(
							$author$project$PlayBack$getMusicIntstrument(music)))),
					_Utils_Tuple2(
					'events',
					A2(
						$elm$json$Json$Encode$list,
						$author$project$PlayBack$encode,
	...
	function (nameOfNote, model, _v0) {
		...
		var disList = function () {
			...
			var filter1 = A2(
				$elm$core$List$map,
				function (z) {
					return A3($author$project$MusicCreator$insertCondition30, restartScoreNote, x, y) ? z : 99999;
				},
				distance);
			var minValue = A3($elm$core$List$foldl, $elm$core$Basics$min, 99999, filter1);
			return A2(
...
var $author$project$MusicCreator$whileDrageSeletedNoteUpdateScoreNote = F2(
	function (nameOfNote, model) {
		...
		var updateNewList = $author$project$MusicCreator$updateScoreNoteYDict(
			A2($author$project$MusicCreator$updateScoreNoteXDict, model.sizeofNote, newList));
		return updateNewList;
	});
	...
	function (msg, model) {
		switch (msg.$) {
			case 'Tick':
				...
				var keys = _v1.a;
				var arrow = _v1.b;
				var tempo = {bpm: model.tempo, duration: 0.25};
				var music = A2(
					$elm$core$List$map,
					function (_v5) {
						var name = _v5.a;
			...
			case 'NotifyTS':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{scoreNoteList: _List_Nil, timeSignature: ts}),
					$elm$core$Platform$Cmd$none);
			case 'NotifyTEMPO':
				var tempo = msg.a;
				return _Utils_Tuple2(
					...
					_Utils_update(
						model,
						{
							scoreNoteList: _Utils_eq(t, $author$project$MusicCreatorDef$Dynamic) ? A3(
								...
								nameOfNote,
								model,
								_Utils_Tuple2(x * $author$project$MusicCreator$adjectmoveSpeed, y * $author$project$MusicCreator$adjectmoveSpeed)) : (_Utils_eq(t, $author$project$MusicCreatorDef$Accidental) ? A3(
								$author$project$MusicCreator$whileDragScoreUpdateAccidental,
								nameOfNote,
								model,
								_Utils_Tuple2(x * $author$project$MusicCreator$adjectmoveSpeed, y * $author$project$MusicCreator$adjectmoveSpeed)) : model.scoreNoteList),
										...
										function (z) {
											if (z.$ === 'Just') {
												...
												return $elm$core$Maybe$Just(
													A4(
														$author$project$MusicCreatorDef$SelectAccidental,
														_Utils_Tuple2(x * $author$project$MusicCreator$adjectmoveSpeed, y * $author$project$MusicCreator$adjectmoveSpeed),
														p.posInit,
														p.dragState,
														p.f));
											} else {
							...
							selectDynamicDict: function () {
								var _v10 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectDynamicDict, $author$project$MusicCreatorDef$defselectDynamicRec);
								if (_v10.$ === 'Dragging') {
									return A3(
										$elm$core$Dict$update,
										nameOfNote,
							...
							trashState: function () {
								var _v13 = A3(
									...
									$elm$core$Dict$fromList(
										$author$project$MusicCreator$createdynamicList(model.scoreNoteList)),
									$author$project$MusicCreatorDef$defselectDynamicRec);
								if (_v13.$ === 'Dragging') {
									return A2(
									...
									var _v14 = A3(
										...
										nameOfNote,
										$elm$core$Dict$fromList(
											$author$project$MusicCreator$createaccidentalList(model.scoreNoteList)),
										$author$project$MusicCreatorDef$defselectAccidentalRec);
									if (_v14.$ === 'Dragging') {
										return A2(
											$author$project$MusicCreator$ifSelectedNoteClosetoTrash,
			...
			case 'Drag':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							pos: function () {
								var _v16 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectNoteDict, $author$project$MusicCreatorDef$defselectNoteRec);
								if (_v16.$ === 'Dragging') {
									return _Utils_Tuple2(x * $author$project$MusicCreator$adjectmoveSpeed, y * $author$project$MusicCreator$adjectmoveSpeed);
								} else {
									return model.pos;
								}
							}(),
							scoreNoteList: function () {
								...
								if (_v17.$ === 'Dragging') {
									...
									var _v18 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectNoteDict, $author$project$MusicCreatorDef$defselectNoteRec);
									if (_v18.$ === 'Dragging') {
							...
							selectNoteDict: function () {
								var _v19 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectNoteDict, $author$project$MusicCreatorDef$defselectNoteRec);
								if (_v19.$ === 'Dragging') {
									return A3(
										$elm$core$Dict$update,
										nameOfNote,
						...
						model,
						{
							scoreNoteList: function () {
								if (_Utils_eq(t, $author$project$MusicCreatorDef$Dynamic)) {
									var _v24 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectDynamicDict, $author$project$MusicCreatorDef$defselectDynamicRec);
									if (_v24.$ === 'Dragging') {
											...
											return A2(
												...
												function (_v26) {
													...
													return _Utils_eq(name, nameOfNote) ? A2(
														...
														_Utils_Tuple2(name, a),
														_Utils_Tuple2(x * $author$project$MusicCreator$adjectmoveSpeed, y * $author$project$MusicCreator$adjectmoveSpeed)) : _Utils_Tuple2(name, a);
												},
												model.scoreNoteList);
										}
									}
									...
									if (_Utils_eq(t, $author$project$MusicCreatorDef$Accidental)) {
										var _v27 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectAccidentalsDict, $author$project$MusicCreatorDef$defselectAccidentalRec);
										if (_v27.$ === 'Dragging') {
											return A2(
												$author$project$MusicCreator$updateScoreNoteXDict,
												model.sizeofNote,
							...
							selectAccidentalsDict: function () {
								var _v30 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectAccidentalsDict, $author$project$MusicCreatorDef$defselectAccidentalRec);
								if (_v30.$ === 'Dragging') {
									return A3(
										$elm$core$Dict$update,
										nameOfNote,
							...
							selectDynamicDict: function () {
								var _v33 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectDynamicDict, $author$project$MusicCreatorDef$defselectDynamicRec);
								if (_v33.$ === 'Released') {
									return A3(
										$elm$core$Dict$update,
										nameOfNote,
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							scoreNoteList: function () {
								var _v39 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectNoteDict, $author$project$MusicCreatorDef$defselectNoteRec);
								if (_v39.$ === 'Released') {
									var _v40 = A3(
										$author$project$MusicCreator$extractDragState,
										nameOfNote,
							...
							selectNoteDict: function () {
								var _v42 = A3($author$project$MusicCreator$extractDragState, nameOfNote, model.selectNoteDict, $author$project$MusicCreatorDef$defselectNoteRec);
								if (_v42.$ === 'Released') {
									return A3(
										$elm$core$Dict$update,
										nameOfNote,
			...
			default:
				var test = _List_fromArray(
					[
						A5(
						$author$project$MusicCreatorDef$SelectNote,
						_Utils_Tuple2($author$project$MusicCreator$noteFirstPos, 0),
						_Utils_Tuple2($author$project$MusicCreator$noteFirstPos, 0),
						$author$project$MusicCreatorDef$Released,
						$author$project$MusicCreatorDef$WholeN,
						$author$project$MusicCreatorDef$defaultFunction)
				...
				var music = A2(
					...
					model.scoreNoteList);
				var myMusic = A2($author$project$MusicCreatorToMusic$creatorToMusic, model.timeSignature, music);
				return _Utils_Tuple2(
					model,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$PlayBack$metronome(
								A2(
									$author$project$PlayBack$perform,
									tempo,
									A2($author$project$MusicCreatorToMusic$metronome, model.timeSignature, music))),
...
var $author$project$MusicCreator$NotifyTEMPO = function (a) {
	return {$: 'NotifyTEMPO', a: a};
};
var $author$project$MusicCreator$NotifyTS = function (a) {
	return {$: 'NotifyTS', a: a};
};
...
var $author$project$MusicCreator$ifDraggedNote = function (list) {
	return A2(
		$elm$core$List$any,
		function (_v0) {
			var name = _v0.a;
...
var $author$project$MusicCreator$assistBox = function (model) {
	var ifSelectNoteDrage = $author$project$MusicCreator$ifDraggedNote(
		$elm$core$Dict$toList(model.selectNoteDict));
	var ifSelectDynaDrag = $author$project$MusicCreator$ifDraggedNote(
		$elm$core$Dict$toList(model.selectDynamicDict));
	var ifSelectAccidentalDrag = $author$project$MusicCreator$ifDraggedNote(
		$elm$core$Dict$toList(model.selectAccidentalsDict));
	var ifScoreNoteDrag = $author$project$MusicCreator$ifDraggedNote(model.scoreNoteList);
	var ifScoreDynaDrage = $author$project$MusicCreator$ifDraggedNote(
		$author$project$MusicCreator$createdynamicList(model.scoreNoteList));
	var ifScoreAccidentalDrag = $author$project$MusicCreator$ifDraggedNote(
		$author$project$MusicCreator$createaccidentalList(model.scoreNoteList));
	...
	var pos = ifScoreNoteDrag ? getpost(model.scoreNoteList) : (ifSelectNoteDrage ? getpost(
		...
		$author$project$MusicCreator$createdynamicList(model.scoreNoteList)) : (ifSelectAccidentalDrag ? getpost(
		$elm$core$Dict$toList(model.selectAccidentalsDict)) : (ifScoreAccidentalDrag ? getpost(
		$author$project$MusicCreator$createaccidentalList(model.scoreNoteList)) : _Utils_Tuple2(99999, 99999))))));
	var x = pos.a;
	var y = pos.b;
	var distance = function () {
		...
		return A2(
			...
			A2(
				...
				A2($author$project$MusicCreator$makeScoreNoteX, $author$project$MusicCreator$noteFirstPos, model.scoreNoteList)));
	}();
	var targetValueHelper = function (condition) {
		...
		var filter1 = A2(
			$elm$core$List$map,
			function (z) {
				return A3(condition, list, x, y) ? z.dis : 9999;
			},
			distance);
		return A3($elm$core$List$foldl, $elm$core$Basics$min, 99999, filter1);
	};
	var targetValue = targetValueHelper($author$project$MusicCreator$insertCondition30);
	var drawBox = (ifSelectDynaDrag || (ifScoreDynaDrage || (ifSelectAccidentalDrag || ifScoreAccidentalDrag))) ? A3(
		$elm$core$List$map2,
		F2(
			function (b, _v0) {
				var name = _v0.a;
				...
				return _Utils_eq(b.dis, targetValue) ? ($author$project$MusicCreatorDef$ifRest(a.note) ? $MacCASOutreach$graphicsvg$GraphicSVG$group(
					_List_fromArray(
						[
							...
							A3(
								...
								A2($MacCASOutreach$graphicsvg$GraphicSVG$rect, model.sizeofNote, 100))),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$move,
							b.pos,
							A2(
								...
								A2(
									$MacCASOutreach$graphicsvg$GraphicSVG$filled,
									$MacCASOutreach$graphicsvg$GraphicSVG$red,
									A2($MacCASOutreach$graphicsvg$GraphicSVG$rect, 1, 100)))),
							A2(
							$MacCASOutreach$graphicsvg$GraphicSVG$move,
							b.pos,
							A2(
					...
					A3(
						...
						A2($MacCASOutreach$graphicsvg$GraphicSVG$rect, model.sizeofNote, 100)))) : $MacCASOutreach$graphicsvg$GraphicSVG$group(_List_Nil);
			}),
		distance,
...
var $author$project$MusicCreator$dynamicToString = function (dynamic) {
	switch (dynamic.$) {
		case 'PP':
			return 'pianissimo';
		case 'P':
...
var $author$project$MusicCreator$ifdottedNote = function (b) {
	switch (b.$) {
		case 'HalfND':
			return true;
		case 'QuarterND':
...
var $author$project$MusicCreator$toElmMusicPitch = F2(
	function (_v0, note) {
		var x = _v0.a;
		var y = _v0.b;
		var p = function (cycle) {
		...
		var ifBracket = function (cycle) {
			return A2(
				$elm$core$String$repeat,
				$elm$core$Basics$round(cycle),
				')');
		};
		var pick = function (cycle) {
			if (p(cycle) >= 0) {
				...
				switch (_v1) {
					case 0:
						return 'Do' + ifBracket(cycle);
					case 1:
						return 'Re' + ifBracket(cycle);
					case 2:
						return 'Mi' + ifBracket(cycle);
					case 3:
						return 'Fa' + ifBracket(cycle);
					case 4:
						return 'Sol' + ifBracket(cycle);
					case 5:
						return 'La' + ifBracket(cycle);
					case 6:
						return 'Ti' + ifBracket(cycle);
					default:
						return '(OctaveUp ' + pick(cycle + 1);
				}
			} else {
				var _v2 = $elm$core$Basics$abs(
					p(cycle));
				switch (_v2) {
					case 1:
						return '(OctaveDown Ti)';
					case 2:
						return '(OctaveDown La)';
					case 3:
						return '(OctaveDown Sol)';
					case 4:
						return '(OctaveDown Fa)';
					case 5:
						return '(OctaveDown Mi)';
					case 6:
						return '(OctaveDown Re)';
					case 7:
						return '(OctaveDown Do)';
					default:
						return 'Error';
				}
			}
		};
		return $author$project$MusicCreatorDef$ifRest(note) ? 'Rest' : pick(0);
	});
var $author$project$MusicCreator$codeHelper = function (listOfNote) {
	var ifdotted = function (b) {
		return $author$project$MusicCreator$ifdottedNote(b.note) ? ' |> dot 1' : '';
	};
	var addLyric = function (lyric) {
		return (lyric !== '') ? (' ' + ('|> sing ' + ('\"' + (lyric + '\"')))) : '';
	};
	var addDynamic = function (dynamic) {
		return (!_Utils_eq(dynamic, $author$project$MusicCreatorDef$NoDynamic)) ? (' ' + ('|> ' + $author$project$MusicCreator$dynamicToString(dynamic))) : '';
	};
	var toElmMusicCodeRaw = A2(
		$elm$core$List$indexedMap,
		$elm$core$Tuple$pair,
		A2(
			$elm$core$List$map,
			function (_v1) {
				var name = _v1.a;
				var b = _v1.b;
				return $author$project$MusicCreator$noteToString(b.note) + (' ' + (A2($author$project$MusicCreator$toElmMusicPitch, b.pos, b.note) + (ifdotted(b) + (addDynamic(b._function.dynamic.f) + addLyric(
...
var $author$project$MusicCreator$code = function (listOfNote) {
	return $MacCASOutreach$graphicsvg$GraphicSVG$group(
		_List_fromArray(
			[
				A2(
...
var $author$project$MusicCreator$drawExtraLine = F2(
	function (pos, state) {
		var newPos = (pos.b >= 0) ? _Utils_Tuple2(pos.a, pos.b - 7) : _Utils_Tuple2(pos.a, pos.b + 7);
		var line = F2(
			function (pos1, num) {
				return (pos1.b >= 0) ? A2(
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					_Utils_Tuple2(pos1.a, 14 + (7 * num)),
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$MacCASOutreach$graphicsvg$GraphicSVG$black,
		...
		return ((_Utils_cmp(pos.b, -36) > -1) && ((pos.b <= 50) && _Utils_eq(state, $author$project$MusicCreatorDef$Dragging))) ? (((pos.b > 14) || (_Utils_cmp(pos.b, -14) < 0)) ? $MacCASOutreach$graphicsvg$GraphicSVG$group(
			_List_fromArray(
				[
					A2(
					line,
					...
					$elm$core$Basics$floor(
						($elm$core$Basics$abs(pos.b) - 14) / 7)),
...
var $author$project$MusicCreator$whichNote = F2(
	function (notes, flip) {
		switch (notes.$) {
			case 'Empty':
	...
	function (listOfNote, scaleSize) {
		...
		var ifRotate = F3(
			function (pos, state, note) {
				return ((pos.b >= 0) && (_Utils_eq(state, $author$project$MusicCreatorDef$Dragging) && (!$author$project$MusicCreatorDef$ifRest(note)))) ? $MacCASOutreach$graphicsvg$GraphicSVG$rotate(
					$elm$core$Basics$degrees(180)) : $MacCASOutreach$graphicsvg$GraphicSVG$rotate(
					$elm$core$Basics$degrees(0));
			});
		var ifFlip = F2(
			function (pos, state) {
				return ((pos.b >= 0) && _Utils_eq(state, $author$project$MusicCreatorDef$Dragging)) ? $author$project$MusicCreatorDef$Flip : $author$project$MusicCreatorDef$UnFlip;
			});
		return $MacCASOutreach$graphicsvg$GraphicSVG$group(
			A2(
				$elm$core$List$map,
								...
								A2(
									...
									A4(
										...
										A2(
											...
											ifscale(b),
											A2(
												$author$project$MusicCreator$whichNote,
												b.note,
...
var $author$project$MusicCreator$whichAccidental = function (accidental) {
	switch (accidental.$) {
		case 'NoAccidental':
			return $MacCASOutreach$graphicsvg$GraphicSVG$group(_List_Nil);
		case 'Sharp':
	...
	function (listOfNote, time) {
		var moveLyric = F2(
			function (_v1, _v2) {
				...
				var nx = _v2.a;
				var ny = _v2.b;
				return (_Utils_cmp(dy, -42) < 1) ? _Utils_Tuple2(nx, dy - 10) : _Utils_Tuple2(nx, -49);
			});
		...
		var ifRotateB = F2(
			function (pos, note) {
				return (pos.b >= 0) && (!$author$project$MusicCreatorDef$ifRest(note));
			});
		var moveDynamic = function (b) {
			var x = A2(ifRotateB, b.pos, b.note) ? (b.pos.a - 3) : b.pos.a;
			var dynamic = b._function.dynamic;
			return _Utils_eq(dynamic.dragState, $author$project$MusicCreatorDef$Released) ? ((b.pos.b >= 10.5) ? _Utils_Tuple2(x, -23) : (((b.pos.b >= 0) && (b.pos.b <= 10.5)) ? _Utils_Tuple2(x, b.pos.b - 33) : (((b.pos.b <= 0) && (_Utils_cmp(b.pos.b, -11) > -1)) ? _Utils_Tuple2(x, -23) : _Utils_Tuple2(x, b.pos.b - 12)))) : dynamic.pos;
		};
		var ifRotate = F2(
			function (pos, note) {
				return ((pos.b >= 0) && (!$author$project$MusicCreatorDef$ifRest(note))) ? $MacCASOutreach$graphicsvg$GraphicSVG$rotate(
					$elm$core$Basics$degrees(180)) : $MacCASOutreach$graphicsvg$GraphicSVG$rotate(
					$elm$core$Basics$degrees(0));
			});
		var ifFlip = function (pos) {
			return (pos.b >= 0) ? $author$project$MusicCreatorDef$Flip : $author$project$MusicCreatorDef$UnFlip;
		};
		return $MacCASOutreach$graphicsvg$GraphicSVG$group(
			A2(
				$elm$core$List$map,
						...
						_List_fromArray(
							[
								...
								A2(
									$MacCASOutreach$graphicsvg$GraphicSVG$move,
									moveAccidental(b),
									$author$project$MusicCreator$whichAccidental(b._function.accidental.f))),
								($author$project$MusicCreatorDef$ifRest(b.note) || _Utils_eq(b.note, $author$project$MusicCreatorDef$Empty)) ? $MacCASOutreach$graphicsvg$GraphicSVG$group(_List_Nil) : A2(
								$MacCASOutreach$graphicsvg$GraphicSVG$move,
								A2(
									moveLyric,
									moveDynamic(b),
									b.pos),
								A3($author$project$MusicCreator$displayLyricList, b._function.lyric, name, time))
							]));
				},
				listOfNote));
	});
...
var $author$project$MusicCreator$drawgroup = F2(
	function (list, time) {
		...
		var pos1 = function () {
			var _v12 = A2($elm$core$List$take, 1, posList);
			if (_v12.b && (!_v12.b.b)) {
				var a = _v12.a;
				return _Utils_Tuple2(
					a.a,
		...
		var drawNote = function () {
			...
			var moveLyric = F2(
				function (_v8, _v9) {
					...
					var nx = _v9.a;
					var ny = _v9.b;
					return (_Utils_cmp(dy, -42) < 1) ? _Utils_Tuple2(nx, dy - 20) : _Utils_Tuple2(nx, -49);
				});
			...
			var moveDynamic = F2(
				function (a, b) {
					return _Utils_eq(a._function.dynamic.dragState, $author$project$MusicCreatorDef$Dragging) ? a._function.dynamic.pos : (ifPointUp ? ((_Utils_cmp(a.pos.b, -14) > -1) ? _Utils_Tuple2(a.pos.a, -23) : _Utils_Tuple2(a.pos.a, a.pos.b - 12)) : _Utils_Tuple2(
						a.pos.a - 3,
						staffPos(b).b - 12));
				});
			return A3(
							...
							_List_fromArray(
								[
									...
									A2(
										$MacCASOutreach$graphicsvg$GraphicSVG$move,
										moveAccidental(a),
										$author$project$MusicCreator$whichAccidental(a._function.accidental.f))),
									$author$project$MusicCreatorDef$ifRest(a.note) ? $MacCASOutreach$graphicsvg$GraphicSVG$group(_List_Nil) : A2(
									$MacCASOutreach$graphicsvg$GraphicSVG$move,
									A2(
										moveLyric,
										A2(moveDynamic, a, b),
...
var $author$project$MusicCreator$Group = function (a) {
	return {$: 'Group', a: a};
};
var $author$project$MusicCreator$Single = function (a) {
	return {$: 'Single', a: a};
};
var $author$project$MusicCreator$groupByBeaming = F2(
	function (list, ts) {
		var ifFitOneBeat = F3(
					...
					if (!listx.b) {
						...
						if (_Utils_eq(
							...
							if (_Utils_cmp(
								count,
								$author$project$MusicCreator$onebeat(ts)) < 0) {
								var $temp$count = count + $author$project$MusicCreatorDef$noteToFraction(x.note),
									$temp$listx = xs,
									$temp$tmp = _Utils_ap(
									tmp,
									_List_fromArray(
		...
		var checkEachBeaming = F2(
			function (listx, carry) {
				...
				if (!listx.b) {
					...
					var x = _v3.b;
					var xs = listx.b;
					if (!(($author$project$MusicCreatorDef$noteToFraction(x.note) + carry) - ($author$project$MusicCreator$onebeat(ts) * xBeatModOneBeat(x.note)))) {
						return A2(
							$elm$core$List$cons,
							_List_fromArray(
								[
						...
						if (!xBeatModOneBeat(x.note)) {
							...
							var beamingGroup = A3(
								ifFitOneBeat,
								$author$project$MusicCreatorDef$noteToFraction(x.note) - ($author$project$MusicCreator$onebeat(ts) * xBeatModOneBeat(x.note)),
								xs,
								_List_Nil);
							return A2(
								$elm$core$List$cons,
...
var $author$project$MusicCreator$ifOneBeatUnfull = F2(
	function (list, ts) {
		var notecount = A3(
			$elm$core$List$foldl,
			F2(
		...
		return (_Utils_cmp(
			notecount,
			$author$project$MusicCreator$onebeat(ts)) < 1) ? true : false;
	});
var $author$project$MusicCreator$groupNoteList = F2(
	function (list, ts) {
		var toGroupNoteTypeList = function (x) {
			return A2(
				$elm$core$List$map,
				function (a) {
					return $author$project$MusicCreator$Single(a);
				},
				x);
		};
					...
					if (!x.b.b) {
						...
						if (x1.$ === 'Single') {
							...
							if (x2.$ === 'Single') {
								...
								var s2 = _v5.b;
								if (_Utils_cmp(
									$author$project$MusicCreatorDef$noteToFraction(s1.note),
									$author$project$MusicCreator$onebeat(ts)) > -1) {
									return A2(
										$elm$core$List$cons,
										x1,
										groupping(
									...
									if (A2(ifGroupSingles, s1, s2)) {
										var $temp$x = A2(
											$elm$core$List$cons,
											$author$project$MusicCreator$Group(
												_List_fromArray(
													[
							...
							if (x2.$ === 'Single') {
								...
								if ($author$project$MusicCreatorDef$ifRest(s2.note)) {
									...
									if (A2(
										$author$project$MusicCreator$ifOneBeatUnfull,
										_Utils_ap(
											g1,
											_List_fromArray(
												[
		...
		var countFract = A3(
			...
			F2(
				function (_v9, def) {
					var name = _v9.a;
					var a = _v9.b;
					return $author$project$MusicCreatorDef$noteToFraction(a.note) + def;
				}),
			0,
			list);
		...
		return (_Utils_eq(ts, $author$project$MusicCreatorDef$Ts44) && ((countFract === 1) && allEighthNote)) ? allEighthNoteCase : $elm$core$List$concat(
			A2(
				...
				A2($author$project$MusicCreator$groupByBeaming, list, ts)));
	});
var $author$project$MusicCreator$drawNotesWithExtraLineWithGroup = F3(
	function (model, listOfNote, ts) {
		...
		var groupList = A2($author$project$MusicCreator$groupNoteList, listOfNote, ts);
...
var $author$project$MusicCreator$drawTS = function (ts) {
	switch (ts.$) {
		case 'Ts44':
...
var $author$project$DrawMusic$drawTemp = function (tempo) {
	return $MacCASOutreach$graphicsvg$GraphicSVG$group(
		_List_fromArray(
			[
				A2(
		...
		return $MacCASOutreach$graphicsvg$GraphicSVG$group(
			_List_fromArray(
				[
					...
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					model.trashPos,
					A2($MacCASOutreach$graphicsvg$GraphicSVG$scale, 0.7, $author$project$DrawMusic$trashCanOpen))
				]));
	} else {
		return $MacCASOutreach$graphicsvg$GraphicSVG$group(
			_List_fromArray(
				[
					...
					$MacCASOutreach$graphicsvg$GraphicSVG$move,
					model.trashPos,
					A2($MacCASOutreach$graphicsvg$GraphicSVG$scale, 0.7, $author$project$DrawMusic$trashCanClosed))
				]));
	}
};
...
var $author$project$MusicCreator$frameForSelectedNote = function () {
	var restText = A2($elm$core$List$repeat, 5, 'Rest');
	var noteText = A2($elm$core$List$repeat, 5, 'Note');
	var durationText = _List_fromArray(
		['whole', 'half', 'quarter', 'eighth', 'sixteenth']);
	var displayText = F4(
		function (list, x, y, adx) {
			return A3(
				$elm$core$List$map2,
				F2(
					function (a, b) {
			...
			[
				...
				A3(
					...
					A2(
						$MacCASOutreach$graphicsvg$GraphicSVG$filled,
						$MacCASOutreach$graphicsvg$GraphicSVG$white,
						A2($MacCASOutreach$graphicsvg$GraphicSVG$rect, 55, 30))))
			]));
}();
...
var $author$project$DrawMusic$score = $MacCASOutreach$graphicsvg$GraphicSVG$group(
	_List_fromArray(
		[
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$move,
...
var $author$project$MusicCreatorDef$SelectTempo = F2(
	function (pos, f) {
		return {f: f, pos: pos};
	});
var $author$project$MusicCreator$selectTempo = _List_fromArray(
	[
		A2(
		$author$project$MusicCreatorDef$SelectTempo,
		_Utils_Tuple2(70, -23),
		100),
		A2(
		$author$project$MusicCreatorDef$SelectTempo,
...
var $author$project$MusicCreatorDef$SelectTimeSigniture = F2(
	function (pos, f) {
		return {f: f, pos: pos};
	});
var $author$project$MusicCreatorDef$Ts24 = {$: 'Ts24'};
var $author$project$MusicCreatorDef$Ts34 = {$: 'Ts34'};
var $author$project$MusicCreator$selectTimeSigniture = _List_fromArray(
	[
		A2(
		$author$project$MusicCreatorDef$SelectTimeSigniture,
		_Utils_Tuple2(72, -30),
		$author$project$MusicCreatorDef$Ts44),
		A2(
		$author$project$MusicCreatorDef$SelectTimeSigniture,
		_Utils_Tuple2(82, -30),
		$author$project$MusicCreatorDef$Ts34),
		A2(
		$author$project$MusicCreatorDef$SelectTimeSigniture,
		_Utils_Tuple2(92, -30),
		$author$project$MusicCreatorDef$Ts24)
	]);
var $author$project$MusicCreator$tapAndPop = F4(
	function (list, scaleSize, drawF, notifyF) {
		var draw = A2(
			$elm$core$List$map,
			function (a) {
				return A2(
...
var $author$project$MusicCreator$noteToStringWArt = function (notes) {
	switch (notes.$) {
		case 'Empty':
			return 'empty';
		case 'WholeN':
...
var $author$project$MusicCreator$warning = function (model) {
	var draggedNote = $author$project$MusicCreator$getDraggedNote(
		$elm$core$Dict$toList(model.selectNoteDict));
	var valid = A2(
		$author$project$MusicCreator$ifMeasureUnfull,
		function (l) {
			return A2(
				$elm$core$List$append,
				l,
		...
		model.timeSignature);
	return valid ? $MacCASOutreach$graphicsvg$GraphicSVG$group(_List_Nil) : $MacCASOutreach$graphicsvg$GraphicSVG$group(
		_List_fromArray(
			[
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$filled,
				...
				A2(
					...
					A2(
						...
						10,
						$MacCASOutreach$graphicsvg$GraphicSVG$text(
							$author$project$MusicCreator$noteToStringWArt(draggedNote.b.note)))))
			]));
};
var $author$project$MusicCreator$attempScoreListWithScoreNote = function (model) {
	var scoreNoteListWithoutDraggedNote = $elm$core$List$concat(
		A2(
			...
			model.scoreNoteList));
	var note = $author$project$MusicCreator$getDraggedNote(model.scoreNoteList);
	var attemptList = F2(
		function (cycle, list) {
			if (!list.b) {
				return _List_Nil;
...
var $author$project$MusicCreator$attempScoreListWithSelecNote = function (model) {
	var note = $author$project$MusicCreator$getDraggedNote(
		$elm$core$Dict$toList(model.selectNoteDict));
	var attemptList = F2(
		function (cycle, list) {
			if (!list.b) {
...
var $author$project$MusicCreator$warningEachBeat = function (model) {
	var draggedNote = $author$project$MusicCreator$ifDraggedNote(
		$elm$core$Dict$toList(model.selectNoteDict)) ? $author$project$MusicCreator$getDraggedNote(
		$elm$core$Dict$toList(model.selectNoteDict)) : $author$project$MusicCreator$getDraggedNote(model.scoreNoteList);
	var attemptList = $author$project$MusicCreator$ifDraggedNote(
	...
	var countListbeats = A3(
		...
		F2(
			function (a, def) {
				return $author$project$MusicCreatorDef$noteToFraction(a) + def;
			}),
		0,
		attemptList);
	var valid = A2($author$project$MusicCreator$checkBeaming, attemptList, model.timeSignature);
	var invalidBeat = valid.b ? 0 : valid.a;
	return valid.b ? $MacCASOutreach$graphicsvg$GraphicSVG$group(
		_List_fromArray(
			[
				A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				...
				A2(
					...
					A2(
						...
						10,
						$MacCASOutreach$graphicsvg$GraphicSVG$text(
							$elm$core$Debug$toString(countListbeats)))))
			])) : $MacCASOutreach$graphicsvg$GraphicSVG$group(
		_List_fromArray(
			[
				A2(
				...
				A2(
					...
					A2(
						...
						10,
						$MacCASOutreach$graphicsvg$GraphicSVG$text(
							$author$project$MusicCreator$noteToStringWArt(draggedNote.b.note) + (' ' + $elm$core$Debug$toString(invalidBeat))))))
			]));
};
var $author$project$MusicCreator$myShapes = function (model) {
	return _List_fromArray(
		[
			...
			$author$project$MusicCreator$frameForSelectedNote,
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$move,
			_Utils_Tuple2(0, -50),
			$author$project$MusicCreator$code(model.scoreNoteList)),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$move,
			_Utils_Tuple2(120, 0),
			A2($MacCASOutreach$graphicsvg$GraphicSVG$scale, 0.27, $author$project$DrawMusic$bar)),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$move,
			_Utils_Tuple2(-72, 2.6),
			A2(
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(-145, 0),
				$author$project$MusicCreator$drawTS(model.timeSignature))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$scale,
			$author$project$MusicCreatorDef$scaleNote,
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(-60, 20),
				$author$project$MusicCreator$warning(model))),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$scale,
			$author$project$MusicCreatorDef$scaleNote,
			A2(
			...
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$move,
				_Utils_Tuple2(60, 0),
				$author$project$DrawMusic$score)),
			A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$scale,
			$author$project$MusicCreatorDef$scaleNote,
			...
			A4(
				...
				$elm$core$Dict$toList(model.selectAccidentalsDict),
				0.6,
				$author$project$MusicCreator$whichAccidental,
				$author$project$MusicCreatorDef$Accidental)),
			A4($author$project$MusicCreator$tapAndPop, $author$project$MusicCreator$selectTimeSigniture, 0.25, $author$project$MusicCreator$drawTS, $author$project$MusicCreator$NotifyTS),
			A4($author$project$MusicCreator$tapAndPop, $author$project$MusicCreator$selectTempo, 0.25, $author$project$DrawMusic$drawTemp, $author$project$MusicCreator$NotifyTEMPO),
			$MacCASOutreach$graphicsvg$GraphicSVG$group(
			A2(
				$elm$core$List$map,
				function (_v0) {
