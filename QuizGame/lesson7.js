...
var $author$project$ElmMusic$eighth = function (pitch) {
	return {articulation: $author$project$ElmMusic$ArtUnspecified, duration: $author$project$ElmMusic$Eighth, dynamic: $author$project$ElmMusic$DynUnspecified, lyric: '', pitch: pitch, video: $author$project$ElmMusic$ContinueVideo};
};
...
var $author$project$ElmMusic$half = function (pitch) {
	return {articulation: $author$project$ElmMusic$ArtUnspecified, duration: $author$project$ElmMusic$Half, dynamic: $author$project$ElmMusic$DynUnspecified, lyric: '', pitch: pitch, video: $author$project$ElmMusic$ContinueVideo};
};
...
var $author$project$ElmMusic$lowerOctave = function (note) {
	var octaveDown = function (pitch) {
		switch (pitch.$) {
			case 'Rest':
...
var $author$project$ElmMusic$raiseOctave = function (note) {
	var octaveUp = function (pitch) {
		switch (pitch.$) {
			case 'Rest':
				return $author$project$ElmMusic$Rest;
			case 'OctaveUp':
			...
			default:
				var p = pitch;
				return $author$project$ElmMusic$OctaveUp(p);
		}
	};
	return _Utils_update(
		note,
		{
			pitch: octaveUp(note.pitch)
		});
};
...
var $author$project$ElmMusic$sixteenth = function (pitch) {
	return {articulation: $author$project$ElmMusic$ArtUnspecified, duration: $author$project$ElmMusic$Sixteenth, dynamic: $author$project$ElmMusic$DynUnspecified, lyric: '', pitch: pitch, video: $author$project$ElmMusic$ContinueVideo};
};
...
var $author$project$ElmMusic$whole = function (pitch) {
	return {articulation: $author$project$ElmMusic$ArtUnspecified, duration: $author$project$ElmMusic$Whole, dynamic: $author$project$ElmMusic$DynUnspecified, lyric: '', pitch: pitch, video: $author$project$ElmMusic$ContinueVideo};
};
var $author$project$Master$allQs = _List_fromArray(
	[
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '         Measure [', '    quarter sol |> raiseOctave', '        ]', '        ]]', '        ']),
		function (model) {
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$raiseOctave(
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '    half me', '        ]', '        ]]', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$half($author$project$ElmMusic$me)
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '    eighth mi |> raiseOctave', '  , eighth ri |> raiseOctave', '        ]', '        ]]     ', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
						...
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$eighth($author$project$ElmMusic$mi)),
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$eighth($author$project$ElmMusic$ri))
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '    sixteenth la |> lowerOctave ', '        ]', '        ]]         ', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$lowerOctave(
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$la))
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '    eighth la |> lowerOctave ', '  , eighth la |> lowerOctave ', '        ]', '        ]]   ', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
						...
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$lowerOctave(
										$author$project$ElmMusic$eighth($author$project$ElmMusic$la)),
										$author$project$ElmMusic$lowerOctave(
										$author$project$ElmMusic$eighth($author$project$ElmMusic$la))
									]))
							])
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '    quarter mi', '  , half sol |> raiseOctave', '        ]', '        ]]  ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$half($author$project$ElmMusic$sol))
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '    whole le', '        ]', '        ]] ', '  ', '  ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$whole($author$project$ElmMusic$le)
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[ ', '          Measure [', '    half di |> raiseOctave', '  , half do |> raiseOctave', '        ]', '        ]]', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
						...
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$half($author$project$ElmMusic$di)),
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$half($author$project$ElmMusic$do))
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[ ', '          Measure [', '    half me |> raiseOctave', '  , half fi', '        ]', '        ]]', ' ', '', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$half($author$project$ElmMusic$me)),
										$author$project$ElmMusic$half($author$project$ElmMusic$fi)
									]))
							])
						])));
		})
