...
var $author$project$ElmMusic$accent = function (note) {
	return _Utils_update(
		note,
		{articulation: $author$project$ElmMusic$Accent});
};
...
var $author$project$ElmMusic$slur = function (note) {
	return _Utils_update(
		note,
		{articulation: $author$project$ElmMusic$Slur});
};
...
var $author$project$ElmMusic$staccato = function (note) {
	return _Utils_update(
		note,
		{articulation: $author$project$ElmMusic$Staccato});
};
var $author$project$ElmMusic$Tenuto = {$: 'Tenuto'};
var $author$project$ElmMusic$tenuto = function (note) {
	return _Utils_update(
		note,
		{articulation: $author$project$ElmMusic$Tenuto});
};
var $author$project$Master$allQs = _List_fromArray(
	[
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '                  quarter fa |> staccato', '                  ]', '        ]]', '  ', '']),
		function (model) {
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$staccato(
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '                  quarter re |> tenuto', '                  ]', '        ]]', '  ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$tenuto(
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '                  quarter re |> staccatissimo', '                  ]', '        ]]', '  ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '                  eighth la |> slur,', '                  eighth sol', '                  ]', '        ]]', '  ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '                  quarter sol |> accent', '                  ]', '        ]]', '  ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$accent(
