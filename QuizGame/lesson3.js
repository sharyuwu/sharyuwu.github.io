...
var $author$project$ElmMusic$fortissimo = function (note) {
	return _Utils_update(
		note,
		{dynamic: $author$project$ElmMusic$DynFortissimo});
};
...
var $author$project$ElmMusic$pianissimo = function (note) {
	return _Utils_update(
		note,
		{dynamic: $author$project$ElmMusic$DynPianissimo});
};
var $author$project$ElmMusic$DynPiano = {$: 'DynPiano'};
var $author$project$ElmMusic$piano = function (note) {
	return _Utils_update(
		note,
		{dynamic: $author$project$ElmMusic$DynPiano});
};
...
var $author$project$Master$allQs = _List_fromArray(
	[
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '                  quarter sol |> mezzoForte', '                  ]', '        ]]', '  ', '']),
		function (model) {
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '                  quarter do |> piano', '                  ]', '        ]]', '  ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '                  quarter re |> fortissimo', '                  ]', '        ]]', '  ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$fortissimo(
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [', '                  quarter ti |> pianissimo', '                  ]', '        ]]', '  ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$pianissimo(
