...
var $author$project$ElmMusic$dot = F2(
	function (num, note) {
		var _v0 = $elm$core$Basics$abs(num);
		if (!_v0) {
			return note;
		} else {
			var n = _v0;
			return A2(
				$author$project$ElmMusic$dot,
				n - 1,
				_Utils_update(
					note,
					{
						duration: $author$project$ElmMusic$Dotted(note.duration)
					}));
		}
	});
...
var $author$project$ElmMusic$rest = $author$project$ElmMusic$Rest;
...
var $author$project$ElmMusic$tie = function (note) {
	return _Utils_update(
		note,
		{articulation: $author$project$ElmMusic$Tie});
};
var $author$project$Master$allQs = _List_fromArray(
	[
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [   eighth sol', '                    , eighth sol |> tie', '                    , quarter sol', '                  ]', '        ]]', '        ']),
		function (model) {
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$eighth($author$project$ElmMusic$sol),
										$author$project$ElmMusic$tie(
										$author$project$ElmMusic$eighth($author$project$ElmMusic$sol)),
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [   eighth sol', '                    , sixteenth do |> raiseOctave', '                    , sixteenth ti', '                  ]', '        ]]', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$do)),
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$ti)
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [   quarter re |> raiseOctave |> dot 1', '                    , eighth fa |> raiseOctave', '                  ]', '        ]]     ', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$eighth($author$project$ElmMusic$fa))
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [   sixteenth sol', '                    , sixteenth do |> raiseOctave', '                    , eighth mi |> raiseOctave', '                  ]', '        ]]         ', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$sol),
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$do)),
										$author$project$ElmMusic$raiseOctave(
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [ eighth sol |> dot 1', '                  , sixteenth la', '                  , sixteenth re |> raiseOctave', '                  , eighth sol |> dot 1', '                  ]', '        ]]   ', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$re)),
										A2(
										$author$project$ElmMusic$dot,
										1,
										$author$project$ElmMusic$eighth($author$project$ElmMusic$sol))
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [   sixteenth sol', '                    , sixteenth la', '                    , sixteenth ti', '                    , sixteenth do |> raiseOctave', '                    , sixteenth mi |> raiseOctave', '                    , sixteenth re |> raiseOctave', '                    , sixteenth do |> raiseOctave', '                    , sixteenth ti', '                  ]', '        ]]  ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$do)),
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$mi)),
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$re)),
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$do)),
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure [   sixteenth fa', '                    , eighth fa', '                    , sixteenth fa', '                    , quarter fa', '                  ]', '        ]] ', '  ', '  ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$fa),
										$author$project$ElmMusic$eighth($author$project$ElmMusic$fa),
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$fa),
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[ ', '          Measure [ quarter mi |> raiseOctave |> dot 1', '                  , eighth do |> raiseOctave', '                  , eighth do |> raiseOctave', '                  , eighth mi |> raiseOctave', '                  ]', '        ]]', '        ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$eighth($author$project$ElmMusic$do)),
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$eighth($author$project$ElmMusic$do)),
										$author$project$ElmMusic$raiseOctave(
										$author$project$ElmMusic$eighth($author$project$ElmMusic$mi))
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[ ', '          Measure [ quarter do |> raiseOctave', '                  , quarter do |> raiseOctave', '                  , eighth sol', '                  , eighth do |> raiseOctave', '                  , eighth la', '                  , eighth sol', '                  ]', '        ]]', ' ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[ ', '          Measure [ quarter rest', '                  , quarter rest', '                  , eighth re |> dot 1', '                  , sixteenth re', '                  ]', '        ]]', '', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$ElmMusic$dot,
										1,
										$author$project$ElmMusic$eighth($author$project$ElmMusic$re)),
										$author$project$ElmMusic$sixteenth($author$project$ElmMusic$re)
									]))
							])
						])));
