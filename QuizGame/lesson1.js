...
var $author$project$Master$allQs = _List_fromArray(
	[
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  quarter do ', '                ]', '        ]]']),
		function (model) {
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  half re', '                ]', '        ]]']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$half($author$project$ElmMusic$re)
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  whole mi', '                ]', '        ]]']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$whole($author$project$ElmMusic$mi)
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  quarter do |> raiseOctave', '                ]', '        ]]']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  whole ti ', '                ]', '        ]]']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$whole($author$project$ElmMusic$ti)
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  half sol ', '                ]', '        ]]']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  whole fa ', '                ]', '        ]]']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$whole($author$project$ElmMusic$fa)
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  whole rest  ', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$whole($author$project$ElmMusic$rest)
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  half rest  ', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					...
					_List_fromArray(
						[
							...
							[
								...
								_List_fromArray(
									[
										$author$project$ElmMusic$half($author$project$ElmMusic$rest)
									]))
							])
						])));
		}),
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  quarter rest  ', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  half sol,', '                  half sol', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  quarter mi,', '                  half fa,', '                  quarter re', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$ElmMusic$half($author$project$ElmMusic$fa),
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano ThreeFour', '        [[', '          Measure', '                [', '                  quarter rest,', '                  quarter mi,', '                  quarter ti', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					$author$project$ElmMusic$Piano,
					$author$project$ElmMusic$ThreeFour,
					_List_fromArray(
						[
							_List_fromArray(
							[
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano TwoFour', '        [[', '          Measure', '                [', '                  half sol', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
					$author$project$ElmMusic$Piano,
					$author$project$ElmMusic$TwoFour,
					_List_fromArray(
						[
							_List_fromArray(
							[
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  quarter do |> raiseOctave,', '                  quarter mi,', '                  half rest ', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  half rest,', '                  half fa', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano FourFour', '        [[', '          Measure', '                [', '                  half fa,', '                  quarter ti,', '                  quarter la', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano TwoFour', '        [[', '          Measure', '                [', '                  quarter la,', '                  quarter la', '                ]', '        ]] ']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
		...
		_Utils_Tuple2(
		_List_fromArray(
			['  Music Piano ThreeFour', '        [[', '          Measure', '                [', '                  quarter ti,', '                  quarter rest,', '                  quarter do', '                ]', '        ]] ', '']),
		function (model) {
			return $author$project$Master$ElmMusic(
				A3(
					$author$project$ElmMusic$Music,
